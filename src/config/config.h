...
{    
    namespace config 
    {
        ...
        struct Base
        {
            ...
            using DEV_SPEC 
                = rlt::devices::cpu::Specification<rlt::devices::math::CPU, 
            ...
            using ENVIRONMENT 
                = typename parameters::environment<T, TI, ABLATION_SPEC>::ENVIRONMENT;
            ...
            using ENVIRONMENT_EVALUATION 
                = typename parameters::environment<T, TI, ABLATION_SPEC_EVAL_INSTANCE>::ENVIRONMENT;
